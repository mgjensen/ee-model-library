...
ROW_MAP: dict[tuple[str, str, str], int] = {
    ...
    ("Revenue", "REV_002", "gross_revenue"):                    55,
    ("Revenue", "REV_002", "total_costs"):                      56,
    ("Revenue", "REV_002", "net_revenue"):                      57,

    # ---- Revenue sheet — REV_003 (rows 59–81) — Wind revenue ---------------
    ("Revenue", "REV_003", "net_production_MWh"):          60,
    ("Revenue", "REV_003", "price_indexation_factor"):     61,
    ("Revenue", "REV_003", "wholesale_inflated"):          62,
    ("Revenue", "REV_003", "capture_inflated"):            63,
    ("Revenue", "REV_003", "spot_revenue"):                64,
    ("Revenue", "REV_003", "total_ppa_contracted_volume"): 65,
    ("Revenue", "REV_003", "total_ppa_fixed_payment"):     66,
    ("Revenue", "REV_003", "total_ppa_settlement"):        67,
    ("Revenue", "REV_003", "total_ppa_net_settlement"):    68,
    ("Revenue", "REV_003", "total_ppa_capture_compensation"): 69,
    ("Revenue", "REV_003", "total_ppa_revenue"):           70,
    ("Revenue", "REV_003", "goo_volume"):                  71,
    ("Revenue", "REV_003", "goo_revenue"):                 72,
    ("Revenue", "REV_003", "tso_cost"):                    73,
    ("Revenue", "REV_003", "dso_cost"):                    74,
    ("Revenue", "REV_003", "nordpool_cost"):               75,
    ("Revenue", "REV_003", "ppa_management_cost"):         76,
    ("Revenue", "REV_003", "total_production_costs"):      77,
    ("Revenue", "REV_003", "balancing_cost"):              78,
    ("Revenue", "REV_003", "gross_revenue"):               79,
    ("Revenue", "REV_003", "total_costs"):                 80,
    ("Revenue", "REV_003", "net_revenue"):                 81,
