...
ROW_MAP: dict[tuple[str, str, str], int] = {
    ...
    ("Revenue", "REV_002", "fcas_regulation_revenue"):          56,
    ("Revenue", "REV_002", "fcas_contingency_revenue"):         57,
    ("Revenue", "REV_002", "fcas_total_revenue"):               58,
    ("Revenue", "REV_002", "vta_colocation_compensation"):      59,
    ("Revenue", "REV_002", "vta_capacity_compensation"):        60,
    ("Revenue", "REV_002", "vta_degradation_compensation"):     61,
    ("Revenue", "REV_002", "vta_transmission_compensation"):    62,
    ("Revenue", "REV_002", "vta_total_compensation"):           63,
    ("Revenue", "REV_002", "gross_revenue"):                    64,
    ("Revenue", "REV_002", "total_costs"):                      65,
    ("Revenue", "REV_002", "net_revenue"):                      66,

    # ---- Revenue sheet — REV_003 (rows 69–90) — Wind revenue ---------------
    ("Revenue", "REV_003", "net_production_MWh"):          69,
    ("Revenue", "REV_003", "price_indexation_factor"):     70,
    ("Revenue", "REV_003", "wholesale_inflated"):          71,
    ("Revenue", "REV_003", "capture_inflated"):            72,
    ("Revenue", "REV_003", "spot_revenue"):                73,
    ("Revenue", "REV_003", "total_ppa_contracted_volume"): 74,
    ("Revenue", "REV_003", "total_ppa_fixed_payment"):     75,
    ("Revenue", "REV_003", "total_ppa_settlement"):        76,
    ("Revenue", "REV_003", "total_ppa_net_settlement"):    77,
    ("Revenue", "REV_003", "total_ppa_capture_compensation"): 78,
    ("Revenue", "REV_003", "total_ppa_revenue"):           79,
    ("Revenue", "REV_003", "goo_volume"):                  80,
    ("Revenue", "REV_003", "goo_revenue"):                 81,
    ("Revenue", "REV_003", "tso_cost"):                    82,
    ("Revenue", "REV_003", "dso_cost"):                    83,
    ("Revenue", "REV_003", "nordpool_cost"):               84,
    ("Revenue", "REV_003", "ppa_management_cost"):         85,
    ("Revenue", "REV_003", "total_production_costs"):      86,
    ("Revenue", "REV_003", "balancing_cost"):              87,
    ("Revenue", "REV_003", "gross_revenue"):               88,
    ("Revenue", "REV_003", "total_costs"):                 89,
    ("Revenue", "REV_003", "net_revenue"):                 90,

    # ---- Revenue sheet — PPA_CFD_001 (rows 92–94) ----------------------------
    ("Revenue", "PPA_CFD_001", "cfd_flag"):              92,
    ("Revenue", "PPA_CFD_001", "settlement_value"):       93,
    ("Revenue", "PPA_CFD_001", "strike_price_indexed"):   94,
    ...
    # ---- Debt sheet — TAX_AU_001 (rows 120–121) -----------------------------
    ("Debt", "TAX_AU_001", "tax_charge_accrued"):      120,
    ("Debt", "TAX_AU_001", "loss_carried_forward"):    121,
...
FIELD_LABELS: dict[str, str] = {
    ...
    # REV_002 — FCAS
    "fcas_regulation_revenue":       "FCAS Regulation Revenue",
    "fcas_contingency_revenue":      "FCAS Contingency Revenue",
    "fcas_total_revenue":            "FCAS Total Revenue",
    # REV_002 — VTA compensation
    "vta_colocation_compensation":   "VTA Co-location Compensation",
    "vta_capacity_compensation":     "VTA Capacity Shortfall Compensation",
    "vta_degradation_compensation":  "VTA Degradation Compensation",
    "vta_transmission_compensation": "VTA Transmission Loss Compensation",
    "vta_total_compensation":        "VTA Total Compensation",
    # Shared
